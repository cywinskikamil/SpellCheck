...
/** Makro trzymające nazwę listy słowników.*/
#define DICT_LIST "dict.list"
/** Makro opisujące maksymalną długosc nazwy słownika. **/
#define MAX_LANG_LENGTH 1000
...
// void pokazReguly(struct dictionary * dict);
